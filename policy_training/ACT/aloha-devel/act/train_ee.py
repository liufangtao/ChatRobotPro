...
from utils_ee import load_data 
from utils_ee import compute_dict_mean, set_seed, detach_dict
...
def get_arguments():
    ...
    parser.add_argument('--dataset_dir', action='store', type=str, help='dataset_dir', default='/1T/datas/data20240710')
    parser.add_argument('--ckpt_dir', action='store', type=str, help='ckpt_dir', default='/1T/cobot_magic/aloha_devel/train0713')
    ...
    parser.add_argument('--task_name', action='store', type=str, help='task_name', default='aloha_mobile_dummy_zips', required=False)
