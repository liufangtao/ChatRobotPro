...
from utils_joints_state import load_data 
from utils_joints_state import compute_dict_mean, set_seed, detach_dict
...
def get_arguments():
    ...
    parser.add_argument('--dataset_dir', action='store', type=str, help='dataset_dir', default='/1T/datas/data20240731/_rename')
    parser.add_argument('--ckpt_dir', action='store', type=str, help='ckpt_dir', default='/1T/cobot_magic/aloha_devel/train0731')
    parser.add_argument('--num_episodes', action='store', type=int, help='num_episodes', default=14)
   
    parser.add_argument('--pretrain_ckpt', action='store', type=str, help='pretrain_ckpt', default='', required=False)
    parser.add_argument('--task_name', action='store', type=str, help='task_name', default='transfer_coke_fixed', required=False)
    ...
    parser.add_argument('--batch_size', action='store', type=int, help='batch_size', default=6, required=False)
